...
class AuthenticatedTicketApiTests(TestCase):
    ...
    def test_request_user_list(self):
        """Ticket object 1"""
        reservation_object_1 = Reservation.objects.create(
            user=self.user
        )
        ...
        planetarium_dome_object = sample_planetarium_dome(name="Planetarium Dome Test1", rows=40, seats_in_row=30)
        ...
        """Ticket object 2"""
        reservation_object_2 = Reservation.objects.create(
            user=self.user
        )
        astronomy_show_object = sample_astronomy_show(
        ...
        planetarium_dome_object = sample_planetarium_dome(name="Planetarium Dome Test2", rows=40, seats_in_row=20)
        ...
        res = self.client.get(Ticket_URL)
        expected_ticket_list = Ticket.objects.filter(reservation__user=self.user)
...
class TicketFilteringApiTests(TestCase):
    ...
    def test_filter_ticket_show_session_astronomy_show_title(self):
        ...
        """Ticket object 3"""
        reservation_object_3 = Reservation.objects.create(
            user=self.user
        )
        astronomy_show_object = sample_astronomy_show(
        ...
        planetarium_dome_object = sample_planetarium_dome(name="Planetarium Dome Test3", rows=40, seats_in_row=20)
    ...
    def test_filter_ticket_reservation_user(self):
        ...
        user2 = user_test(username="default_user_1", password="defaultpassword122")
        """Ticket object 2"""
        reservation_object_2 = Reservation.objects.create(
            user=user2
        )
    ...
    def test_filter_ticket_show_session_planetarium_dome_name(self):
        ...
        astronomy_show_object.show_theme.add(sample_show_theme(name="Test3"))
        planetarium_dome_object = sample_planetarium_dome(name="Planetarium Dome 3", rows=40, seats_in_row=20)
        show_session_object_3 = ShowSession.objects.create(
            astronomy_show=astronomy_show_object,
            planetarium_dome=planetarium_dome_object,
            show_time="2024-05-21"
...
class TicketModelsTests(TestCase):
    ...
    def test_show_theme_str(self):
        ...
        self.assertEqual(ticker_object.__str__(),
